...
<?php flash('post_message');?>
  <div class="row mb-3">
    ...
    <div class="col-md-6">
      <a href="<?php echo URLROOT; ?>/admin/portfolios/add" class="btn btn-primary pull-right">
...
<?php foreach($data['portfolios'] as $portfolio) : ?>
  <div class="card card-body mb-3">
    ...
    <a href="<?php echo URLROOT; ?>/admin/portfolios/show/<?php echo $portfolio->portfolioId; ?>" class="btn btn-dark">More</a>
  </div>
<?php endforeach; ?>
