  ...
  <div class="row">
    <div class="col-md-6 mx-auto">
      <div class="card card-body bg-light mt-5">
        ...
        <form action="<?php echo URLROOT;?>/admin/users/login" method="post">
          ...
          <div class="row">
            ...
            <div class="col">
              <a href="<?php echo URLROOT;?>/admin/users/register" class="btn btn-light btn-block">Don't have an account? Register</a>
            </div>
          </div>
        </form>
      </div>
